...
goog.exportSymbol('proto.com.yue.dbservice.queryRequest', null, global);
goog.exportSymbol('proto.com.yue.dbservice.queryResponse', null, global);
 ...
 * @constructor
 */
proto.com.yue.dbservice.queryRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.com.yue.dbservice.queryRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.com.yue.dbservice.queryRequest.displayName = 'proto.com.yue.dbservice.queryRequest';
}
 ...
 * @return {!Object}
 */
proto.com.yue.dbservice.queryRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.com.yue.dbservice.queryRequest.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.com.yue.dbservice.queryRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.com.yue.dbservice.queryRequest}
 */
proto.com.yue.dbservice.queryRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.yue.dbservice.queryRequest;
  return proto.com.yue.dbservice.queryRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.com.yue.dbservice.queryRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.yue.dbservice.queryRequest}
 */
proto.com.yue.dbservice.queryRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.com.yue.dbservice.queryRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.com.yue.dbservice.queryRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.com.yue.dbservice.queryRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.yue.dbservice.queryRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDatasource();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.com.yue.dbservice.queryRequest.prototype.getDatasource = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.com.yue.dbservice.queryRequest.prototype.setDatasource = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 * @constructor
 */
proto.com.yue.dbservice.queryResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.com.yue.dbservice.queryResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.com.yue.dbservice.queryResponse.displayName = 'proto.com.yue.dbservice.queryResponse';
}
 ...
 * @return {!Object}
 */
proto.com.yue.dbservice.queryResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.com.yue.dbservice.queryResponse.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.com.yue.dbservice.queryResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.yue.dbservice.queryResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    result: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.com.yue.dbservice.queryResponse}
 */
proto.com.yue.dbservice.queryResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.yue.dbservice.queryResponse;
  return proto.com.yue.dbservice.queryResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.com.yue.dbservice.queryResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.yue.dbservice.queryResponse}
 */
proto.com.yue.dbservice.queryResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.com.yue.dbservice.queryResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.com.yue.dbservice.queryResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.com.yue.dbservice.queryResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.yue.dbservice.queryResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getResult();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.com.yue.dbservice.queryResponse.prototype.getResult = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.com.yue.dbservice.queryResponse.prototype.setResult = function(value) {
  jspb.Message.setField(this, 1, value);
};
